...
* 浮点融合乘加[<sup>8</sup>](#refer-anchor-8)（Fused Multiple-Add）：即浮点乘法加法运算，在一步执行完毕，采用单次舍入。例如$a + b × c$，未融合乘加将计算酸乘积$b × c$，将其舍入到$N$有效位，将结果加到a，然后舍入到$N$个有效位置；融合乘加将计算整个表达式$a + (b × c)$在将最终结果向下舍入到$N$个有效位之前达到其全精度。在2008年，IEEE754更新加入了FMA操作。
    ...
    + 浮点融合乘加部件[<sup>9</sup>](#refer-anchor-9)
        ...
        + 浮点乘加部件的硬件开销不会太大。
    + ![乘加合并的示意框图](/picture/%E4%B9%98%E5%8A%A0%E5%90%88%E5%B9%B6%E7%9A%84%E7%A4%BA%E6%84%8F%E6%A1%86%E5%9B%BE.png)

    + ![浮点FMA的总体架构](/picture/%E6%B5%AE%E7%82%B9FMA%E7%9A%84%E6%80%BB%E4%BD%93%E6%9E%B6%E6%9E%84.png)
